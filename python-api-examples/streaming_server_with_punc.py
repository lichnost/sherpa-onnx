...
def add_model_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        "--punc-model-dir",
        type=str,
        default="/mgData3/yangbo/sherpa-onnx/checkpoints/punc_ct-transformer_zh-cn-common-vad_realtime-vocab272727",
        help="Absolute dir of the punctuation model",
    )
...
def create_punctuation_pipeline(args):
    inference_pipeline = pipeline(
    task=Tasks.punctuation,
    model=args.punc_model_dir,
            ...
            while self.recognizer.is_ready(stream):    
                ...
                if self.recognizer.is_endpoint(stream):
                    ...
                    if len(result) != 0:
                        ...
                        message['text'] = punc_result
                        message["is_final"] = 1
                        print(f"punc_results: {punc_result}")
...
def main():
    ...
    punc_model = create_punctuation_pipeline(args)
